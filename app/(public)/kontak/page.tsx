      ...
      <div className="max-w-6xl mx-auto px-5 py-16 grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div>
              <label htmlFor={nameId} className="text-sm text-gray-700 block mb-1">
                Nama
              </label>
              <input
                id={nameId}
            ...
            <div>
              <label htmlFor={emailId} className="text-sm text-gray-700 block mb-1">
                Email
              </label>
              <input
                id={emailId}
              ...
              />
              {fieldErrors.email && (
                <p id={`${emailId}-error`} className="text-red-500 text-xs mt-1">
                  {fieldErrors.email}
                </p>
              )}
            </div>
            ...
            <div>
              <label htmlFor={phoneId} className="text-sm text-gray-700 block mb-1">
                No. HP (opsional)
              </label>
              <input
                id={phoneId}
            ...
            <div>
              <label htmlFor={messageId} className="text-sm text-gray-700 block mb-1">
                Pesan
              </label>
              <textarea
                id={messageId}
              ...
              />
              {fieldErrors.message && (
                <p id={`${messageId}-error`} className="text-red-500 text-xs mt-1">
                  {fieldErrors.message}
                </p>
              )}
            </div>
